  ...
  return (
    ...
    <div className="bg-gray-200 sticky top-0 z-50">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === "ravikumar.ug20@nsut.ac.in" ? <div className="flow-root">
        ...
        <header className='relative bg-white'>
          <p className='flex h-5 items-center justify-center bg-pink-600 px-4 text-[12px] font-medium text-white sm:px-6 lg:px-8'
          style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>Get free delivery on Order over ₹300</p>

          <nav aria-label='Top' className='bg-gray-200 px-4  sm:px-6 lg:px-8 shadow-xl' style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
            <div>
              <div className='flex h-12 items-center'>
                ...
                <div className='ml-4 flex lg:ml-0'>
                  <Link to={'/'} className='flex'>
                    <div className='flex'>
                        <h1 className='text-2xl font-bold text-black px-2 py-1 round'
                          style={{ color: mode === 'dark' ? 'white' : '', }}>E-Mart</h1>
                    </div>
                  </Link>
                </div>

                {/* home order allproducts */}
                <div className='ml-auto flex items-center'>
                  <div className='hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6'>
                    ...
                    {
                      user?.user?.email === 'ravikumar.ug20@nsut.ac.in' ? 
